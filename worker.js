...
.folder-card{border:1px solid var(--line);border-radius:18px;background:#fffdf7;padding:16px;cursor:pointer}
...
<div id="bulkWrap" class="bulk-wrap" style="margin-bottom:18px">
  <div class="bulk-bar">
...
const APP_UNLOCK_PASSWORD = "alan-files";
...
el.refreshBtn.onclick = function() { hideFloatingPreview(); loadList(); };
